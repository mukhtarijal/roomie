...
<body class="bg-gray-50 text-gray-800">
    ...
    <nav class="bg-white shadow-lg fixed top-0 w-full z-10">
        <div class="container mx-auto px-4 py-4 flex items-center justify-between">
            <div class="flex items-center space-x-4">
                <img src="{{ asset('storage/roomie.jpg') }}" alt="Roomie Logo" class="h-10">
                <h1 class="text-xl font-bold text-green-600">Roomie</h1>
            </div>
    ...
    <!-- Hero Section -->
    <div class="hero bg-gradient-to-r from-white-400 to-white-600 text-black py-16 text-center relative overflow-hidden mt-16">
        <div class="container mx-auto px-4 flex items-center justify-between">
            <div class="w-full md:w-1/2 pop-up pr-4">
                <h1 class="text-4xl font-bold mb-4 slide-in">Temukan Kos Impianmu Dengan Mudah Dan Cepat Bersama <span class="text-green-600">Roomie</span></h1>
                <p class="text-lg mb-6 fade-in">Roomie menyediakan berbagai pilihan kos yang dapat disesuaikan dengan kebutuhan Anda, mulai dari harga, lokasi, hingga fasilitas lengkap. Temukan kos yang nyaman dan cocok hanya dalam beberapa klik.</p>
                <a href="#" class="inline-block bg-green-500 text-white font-semibold py-3 px-6 rounded-lg shadow-md hover:bg-green-500 transition">Mulai Cari Kos</a>
            </div>
            <div class="w-full md:w-1/2">
                <img src="{{ asset('storage/kamar.jpg') }}" alt="Room Image" class="hero-image pop-up rounded-tl-none rounded-tr-[100px] rounded-bl-[100px] rounded-br-none object-cover">
            </div>
        </div>
    </div>

    <!-- Tentang Kami Section -->
    <div id="tentang-kami" class="tentang-kami bg-gradient-to-r from-white-600 to-green-800 text-white text-center py-16">
        <div class="container mx-auto px-4 pop-up">
            <div class="bg-green-600 text-white p-8 rounded-lg shadow-lg mx-auto max-w-4xl">
                ...
                <p class="text-lg leading-relaxed fade-in mb-6">Roomie hadir khusus untuk memenuhi kebutuhan pencarian kos di wilayah Kota Padang. Kami fokus menyediakan berbagai fitur dan kos sesuai kebutuhan dalam satu platform. Menawarkan pengalaman mudah dengan informasi yang lengkap, Roomie siap membantu menemukan kos idaman Anda. Dengan desain yang elegan, proses pencarian kos bagi siapa saja yang berada di Kota Padang kini lebih cepat dan mudah!</p>
            </div>
        </div>
    </div>
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-center relative">
            ...
            <div class="relative md:col-span-1 mb-8 md:mb-0">
                <img src="{{ asset('storage/a.jpg') }}" alt="Image 1" class="absolute top-0 left-0 w-64 h-64 rounded-lg z-10">
                <img src="{{ asset('storage/b.jpg') }}" alt="Image 2" class="absolute top-16 left-12 w-72 h-72 rounded-lg z-0">
            </div>
            <!-- Right Side: Text -->
            <div class="md:col-span-2 flex flex-col justify-center space-y-8">
                ...
                <p class="text-gray-600 mb-8 text-left">Roomie memberikan kemudahan pencarian kos dalam waktu singkat.</p>
    ...
    <footer class="py-16 text-gray-800 py-10">
        <div class="container mx-auto px-6 text-center">
            <div class="bg-gray-200 p-8 rounded-lg shadow-lg max-w-lg mx-auto">
                ...
                <a href="#" class="inline-block bg-green-500 text-white font-semibold py-3 px-8 rounded-lg shadow-md hover:bg-green-400 transition duration-300">Mulai Cari Kos</a>
            </div>
